insert into USER values (101,'Médéa','mohamed@facebook.com', 'mohamed','laidani','admin', 'ssn101', 'mohameddz');
insert into USER values (102,'New York','athyl@microsoft.com', 'athyl','laidani','admin', 'ssn103', 'athyldz');
insert into USER values (103,'Sydney','tamim@dell.com', 'tamim','laidani','admin', 'ssn105', 'tamim566');
insert into USER values (104,'London','oliver@dell.com', 'oliver','ogami','admin', 'ssn154', 'oli56f');
insert into USER values (105,'Moscow','nana@dell.com', 'nana','ploon','admin', 'ssn188', 'nanaT');
